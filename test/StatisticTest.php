...
class StatisticTest extends SprotsTest {
	 ...
	 */
	protected $VALID_STATISTICNAME = null;
 ...
 */
	public function testInsertValidStatistic(){
		...
		$statistic = new Statistic(null, $this->statistic->getStatisticId, $this->VALID_STATISTIC, $this->VALID_STATISTIC2);
		...
		$this->assertEquals($pdoStatistic->getStatistic(), $this->VALID_STATISTIC, $this->VALID_STATISTICNAME);
	}
	/**
	...
	public function testUpdateValidStatistic(){
		...
		$numRows = $this->getConnection()->getRowCount("statistic");
		//create a new Statistic and insert into mySQL
		$statistic = new Statistic(null,$this->VALID_STATISTIC, $this->VALID_STATISTICNAME);
		$statistic->insert($this->getPDO());
	...
	public function testGetAllValidStatistic() {
		...
		$pdoTweet = $results[0];
		$this->assertEquals($pdoTweet->getStatisticName(), $this->VALID_STATISTICNAME);
	}
}